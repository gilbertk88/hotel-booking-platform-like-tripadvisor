...
<?php //echo $this->getUniqueId(); ?>
				...
				<ul id="topOptions">
				<li class="dropdown" >
								<a class="dropdown-toggle" href="<?php echo $baseUrl; ?>/guestad/main/create" style="color:#81BA10; font-size:13px !important;">+ ADD LISTING </i></a>
						</li>
				</ul>
				...
				<div class="navbar-collapse nav-main-collapse pull-left collapse" style="height: auto;">
					<nav class="nav-main">
						<ul class="nav nav-pills nav-main scroll-menu" id="topMain">
							...
							<li class="dropdown">
								<a class="dropdown-toggle" href="<?php echo $baseUrl; ?>/search">SEE PLACES</i></a>
							</li>
							...
							<li class="dropdown">
								<a class="dropdown-toggle" href="<?php echo $baseUrl; ?>/contactform/main/quote">NEED A WEBSITE/ WEBAPP?</a>
							</li>
...
//echo Yii::app()->request->requestUri; ?>
	...
	<div id="container" <?php echo (demo()) ? 'style="padding-top: 40px;"' : '';?> >
		...
		<div class="footer">
			<?php echo getGA(); ?>
			<p class="slogan">&copy;&nbsp;<?php echo  'Cloudsafari , '.date('Y'); ?></p>
			<!--  -->
		</div>
	...
	<footer id="footer">
			...
			<ul>
				...
				<li><a href="" data-toggle="modal" data-target="#socialInlineModal">FOLLOW US</a>
			...
			<!-- copyright -->
			<span class="hidden-xs">Contact Us: <b>info_at_cloudsafari.com</b> +254-724-848-463 or +254-723-408-263 </span> 

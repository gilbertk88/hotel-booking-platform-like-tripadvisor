    ...
    var sliderRangeFields = [{'field':'price','params':{'field':'price','min':35647,'max':35647,'min_sel':35647,'max_sel':35647,'step':1,'measure_unit':'KES','class':'price-search-select'}},{'field':'floor','params':{'field':'floor','min':0,'max':30,'min_sel':0,'max_sel':30,'step':1,'class':'floor-search-select'}}];
